...
Data_Prueba <- Adultos_2017 %>% 
  dplyr::select(c("IngresoLaboral_Mes","AniosEscolaridad","ExperienciaPotencial","Poblacion_2017_Dane","Homicidios_2018_base2018","GeneradorEmpleo","AutonomiaFiscal_2018_base2017","FacilidadEmpresa_2018","DiversifCanasta_2018_base2018","Sexo","Edad","PosesionInternet","CargaEconomica","PIB_PC2017_Dane","Desempleo_2018")) %>% 
  drop_na(.)

tspls(IngresoLaboral_Mes~AniosEscolaridad+ExperienciaPotencial+Poblacion_2017_Dane+
        Homicidios_2018_base2018,
     GeneradorEmpleo~AutonomiaFiscal_2018_base2017+FacilidadEmpresa_2018+DiversifCanasta_2018_base2018+
       Sexo+Edad+PosesionInternet+CargaEconomica+PIB_PC2017_Dane+Desempleo_2018,
    data = Data_Prueba)
# Resultado: Error de singularidad
...
Data_Prueba <- Adultos_2017 %>% 
  dplyr::select(c("IngresoLaboral_Mes","AniosEscolaridad","ExperienciaPotencial","Poblacion_2017_Dane",
                  "GeneradorEmpleo","AutonomiaFiscal_2018_base2017","FacilidadEmpresa_2018")) %>% 
  drop_na(.)
...
tspls(IngresoLaboral_Mes~AniosEscolaridad+ExperienciaPotencial+Poblacion_2017_Dane,
     GeneradorEmpleo~AutonomiaFiscal_2018_base2017+FacilidadEmpresa_2018+ComplejidadProductiva_2018,
    data = Data_Prueba)
# Resultado: Prueba Error de singularidad. PLT: Parece que vbles de exportacion de tecnologías deben quitarse

Data_Prueba <- Adultos_2017 %>% 
  dplyr::select(c("IngresoLaboral_Mes","AniosEscolaridad","ExperienciaPotencial","Poblacion_2017_Dane",
                  "GeneradorEmpleo","AutonomiaFiscal_2018_base2017","FacilidadEmpresa_2018","Sexo")) %>% 
  drop_na(.)
...
Data_Prueba <- Adultos_2017 %>% 
  dplyr::select(c("IngresoLaboral_Mes","AniosEscolaridad","ExperienciaPotencial",
                  "Poblacion_2017_Dane","Homicidios_2018_base2018",
                  "GeneradorEmpleo","AutonomiaFiscal_2018_base2017","FacilidadEmpresa_2018","Sexo","Edad")) %>% 
  drop_na(.)
...
tspls(IngresoLaboral_Mes~AniosEscolaridad+ExperienciaPotencial+Poblacion_2017_Dane+Homicidios_2018_base2018,
     GeneradorEmpleo~AutonomiaFiscal_2018_base2017+FacilidadEmpresa_2018+Sexo+PosesionComputador,
    data = Data_Prueba)
# Resultado: Prueba 17.
...
tspls(IngresoLaboral_Mes~AniosEscolaridad+ExperienciaPotencial+Poblacion_2017_Dane+Homicidios_2018_base2018,
     GeneradorEmpleo~AutonomiaFiscal_2018_base2017+FacilidadEmpresa_2018+Sexo+PosesionInternet,
    data = Data_Prueba)
# Resultado: Prueba 18.
...
tspls(IngresoLaboral_Mes~AniosEscolaridad+ExperienciaPotencial+Poblacion_2017_Dane+Homicidios_2018_base2018,
     GeneradorEmpleo~AutonomiaFiscal_2018_base2017+FacilidadEmpresa_2018+Sexo+PosesionComputador+CargaEconomica,
    data = Data_Prueba)
# Resultado: Prueba 19.
...
tspls(IngresoLaboral_Mes~AniosEscolaridad+ExperienciaPotencial+Poblacion_2017_Dane+Homicidios_2018_base2018,
     GeneradorEmpleo~AutonomiaFiscal_2018_base2017+FacilidadEmpresa_2018+Sexo+PosesionInternet+CargaEconomica,
    data = Data_Prueba)
# Resultado: Prueba 20.
