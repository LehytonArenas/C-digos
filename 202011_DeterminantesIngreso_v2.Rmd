...
knitr::opts_chunk$set(root.dir="/Volumes/Respaldo/C-digos")
```

```{r Inicial: Librerías y Datas, eval=FALSE}
...
```{r Estadísticas por Ciudad con Survey, eval=FALSE}
...
```{r Tabla Ciudad 2017, eval=FALSE}
...
```{r Etapa 1, eval=FALSE}
# Hagamos para 2017:
# Usamos la data original, ya dividido fex en 12.
# Primero debemos seleccionar las variables de interés en DF original:
...
# Primero miremos algunos modelos para los autoempleados (Logit):
# Incluyendo solo variables de Impuestos
Et1AutoemLog_2017_v1 <- svyglm(Autoempleado~AutonomiaFiscal_2018_base2017+
                         CapacidadRecaudo_2018_base2017,
                       family=quasibinomial, design=AdutosSvy_2017, 
                       na.action = na.omit)
summary(Et1AutoemLog_2017_v1)

# Ahora incluyamos todos los controles:
Et1AutoemLog_2017_v2 <- svyglm(Autoempleado~AutonomiaFiscal_2018_base2017+
                         CapacidadRecaudo_2018_base2017+Sexo+Edad+PosesionComputador+
                           PosesionInternet+CargaEconomica+PIB_PC2017_Dane+
                           Desempleo_2018+Desempleo_2017_Dane,
                       family=quasibinomial, design=AdutosSvy_2017, 
                       na.action = na.omit)
summary(Et1AutoemLog_2017_v2)

# Incuyendo variables de impuestos y de apoyo al emprendimiento:
Et1AutoemLog_2017_v3 <- svyglm(Autoempleado~AutonomiaFiscal_2018_base2017+
                      CapacidadRecaudo_2018_base2017+FacilidadEmpresa_2018+
                        ImpuestosEmpresa_2018+
                           Sexo+Edad+PosesionComputador+
                           PosesionInternet+CargaEconomica+PIB_PC2017_Dane+
                           Desempleo_2018+Desempleo_2017_Dane,
                       family=quasibinomial, design=AdutosSvy_2017, 
                       na.action = na.omit)
summary(Et1AutoemLog_2017_v3)

# Incuyendo variables de impuestos, apoyo al emprendimiento y exportación tecnologías
Et1AutoemLog_2017_v4 <- svyglm(Autoempleado~AutonomiaFiscal_2018_base2017+
                      CapacidadRecaudo_2018_base2017+
                        FacilidadEmpresa_2018+ImpuestosEmpresa_2018+
                        ComplejidadProductiva_2018+DiversifCanasta_2018_base2018+
                           Sexo+Edad+PosesionComputador+
                           PosesionInternet+CargaEconomica+PIB_PC2017_Dane+
                           Desempleo_2018+Desempleo_2017_Dane,
                       family=quasibinomial, design=AdutosSvy_2017, 
                       na.action = na.omit)
summary(Et1AutoemLog_2017_v4)

# Creamos una tabla:
stargazer(Et1AutoemLog_2017_v1,
          Et1AutoemLog_2017_v2,
          type = "latex",
          style="demography")

# Prueba del modelo 2spls: intentarlo con el DF original.
...
# La aplicación no sirve porque la data no está en DF
