...
Data_Etapa3_v2 <- Data_Etapa3_v2 %>% 
  ...
  dplyr::select(.,c(Anio,AREA,Sectores10Cortos,SectoresAgrupa10,PIB,IngresosGeneradores_Svy,
                    IngresosAutoempleados_Svy,CapFinanciero_Anio,CapFinanciero_Mes,
                    AniosEscolaridad,OC_Simple,TOC)) %>% 
  unite(.,ID,c(2:3),sep="_",remove=F)

# eliminamos puntos intermedios:
rm(CiudadOC,CiudadPET,Data_Etapa3,DataOC,DataPET,DataTOC,Ingresos_Simples,Ingresos_Svy,
   KFcieroAnio_Svy,KFcieroMes_Svy,KHumano_Svy,PIB)
