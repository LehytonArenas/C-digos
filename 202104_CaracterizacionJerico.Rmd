...
Recreacion <- Recreacion %>% 
  dplyr::mutate(RecreacionCol2=ifelse(RecreacionCol=="Juntas administradoras locales - JAL","Juntas administradoras locales",RecreacionCol2),
                ...
                RecreacionCol2=ifelse(RecreacionCol=="Consejos comunales de presupuesto participativo","Concejos de presupuesto participativo",RecreacionCol2),
                RecreacionCol2=ifelse(RecreacionCol=="Organización de base o concejos comunitarios","Concejos comunitarios",RecreacionCol2),
...
# Paso opcional: exportamos data:
write_xlsx(Recreacion_v2, "Ilu46_Participación.xlsx")
