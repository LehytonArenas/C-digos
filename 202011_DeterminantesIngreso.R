...
Hogares <- join_all(list(GEIH_VyH_201701_v2,EducJefes_Suma,EducJefes_Max,NiniosEnHogar,IngresosEnHogar,GeneradoresEnHogar,AutoempleadosEnHogar,OcupadosEnHogar,DesempleadosEnHogar), by=c("DIRECTORIO","HOGAR"),type = "full")
...
Data$Anio_Mes <- c("2017_01")

# Exportamos la data mensual:
write_xlsx(Data, "DataMes_201701.xlsx")

prueba <- Data %>% 
  dplyr::filter(is.na(IngresosPorHogar))
